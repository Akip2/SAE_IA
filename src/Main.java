...
public class Main {
    public static void main(String[] args) {
        try {
            ...
            double erreur_cible = 1; //0.01
            int max_iterations = 1000; //100 000
            ...
            double precision = Statistique.calculerPrecision(algoMLP, donneesTest);
            System.out.println("Precision MLP : " + precision*100 + "%");
        }
        catch (IOException e) {
            e.printStackTrace();
        }
